<script>
  ...
  let encryptedCard = "";
  let encryptedCVV = "";
  let encryptedPhone = ""; // Agregar variable para teléfono cifrado
  let decryptedText = "";
  ...
  async function sendData() {
    const data = {
      ...
      CVV: encryptedCVV,
      telefono: encryptedPhone, // Incluir teléfono cifrado
    };
    ...
    <form id="paymentForm">
      ...
      <div class="button-group">
        ...
        <button
          type="button"
          on:click={sendData}
          disabled={!encryptedName || !encryptedCard || !encryptedCVV || !encryptedPhone}
        >
          Enviar Datos
        </button>
      </div>

      {#if encryptedName && encryptedCard && encryptedCVV && encryptedPhone}
        <div class="output" style="margin-top: 20px; font-weight: bold;">
          ...
          <div class="encrypted-section">
            ...
            <input type="text" value={encryptedPhone} readonly />
            <button
              class="copy-button"
              on:click={() => copyToClipboard(encryptedPhone)}
            >
              Copiar
            </button>
          </div>
