<script>
    ...
    let textToDecrypt = ""; // Campo independiente para el texto cifrado
    let decryptedText = ""; // Texto descifrado independiente
    ...
    function independentDecrypt() {
      if (rsaKeys) {
        try {
          decryptedText = atob(textToDecrypt); // Descifrado independiente del texto ingresado
        } catch (error) {
