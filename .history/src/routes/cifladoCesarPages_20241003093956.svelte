...
<div class="app-container">
  <div class="form-container">
    ...
    <div class="cifrado-container">
      ...
      />
      <button on:click={manejarCifrado}>Cifrar</button>
      <div>
        <h4>Resultado del Cifrado:</h4>
        <span>{resultadoCifrado}</span>
        <button on:click={() => copiarAlPortapapeles(resultadoCifrado)}>Copiar</button>
      </div>
    </div>
    ...
    <div class="descifrado-container">
      ...
      />
      <button on:click={manejarDescifrado}>Descifrar</button>
      <div>
        <h4>Resultado del Descifrado:</h4>
        <span>{resultadoDescifrado}</span>
        <button on:click={() => copiarAlPortapapeles(resultadoDescifrado)}>Copiar</button>
      </div>
    </div>
