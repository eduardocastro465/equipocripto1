    ...
    <div class="section">
      ...
      {#if encryptedNombre}
        <div class="encrypted-section">
          ...
          <button
            class="copy-button"
            on:click={() => copyToClipboard(encryptedNombre)}>Copiar</button
          >
        </div>
      {/if}
      ...
      {#if encryptedSSN}
        <div class="encrypted-section">
          ...
          <button
            class="copy-button"
            on:click={() => copyToClipboard(encryptedSSN)}>Copiar</button
          >
        </div>
      {/if}
      ...
      {#if encryptedDireccion}
        <div class="encrypted-section">
          ...
          <button
            class="copy-button"
            on:click={() => copyToClipboard(encryptedDireccion)}>Copiar</button
          >
        </div>
      {/if}
      ...
      {#if encryptedTelefono}
        <div class="encrypted-section">
          ...
          <button
            class="copy-button"
            on:click={() => copyToClipboard(encryptedTelefono)}>Copiar</button
          >
        </div>
      {/if}
    </div>
