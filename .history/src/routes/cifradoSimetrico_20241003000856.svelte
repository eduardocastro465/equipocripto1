<script>
    ...
    function encryptData() {
      ...
      const emailArray = strToUint32Array(email.padEnd(4, " ")); // Ajustar a 4 caracteres
      ...
      encryptedEmail = bufferToHex(teaEncrypt(emailArray, key));
    ...
    function decryptData() {
      ...
      const decryptedEmailArray = teaDecrypt(hexToBuffer(encryptedEmail), key);
      ...
      decryptedEmail = String.fromCharCode(
        decryptedEmailArray[0] & 0xffff,
        (decryptedEmailArray[0] >> 16) & 0xffff,
        decryptedEmailArray[1] & 0xffff,
        (decryptedEmailArray[1] >> 16) & 0xffff
      ).trim();
