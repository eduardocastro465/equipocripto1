...
<main>
  ...
  <div class="container">
    ...
    <div class="section">
      ...
      {#if encryptedData}
        <div class="encrypted-section">
          ...
          <button
            class="copy-button"
            on:click={() => copyToClipboard(encryptedData)}
            >Copiar Cifrado</button
          >
        </div>
      {/if}
    </div>
    ...
    <div class="section">
      ...
      <button on:click={decryptData} disabled={!textToDecrypt}
        >Descifrar Datos</button
      >
      ...
      {#if decryptedText}
        <div class="decrypted-section">
          ...
          <button
            class="copy-button"
            on:click={() => copyToClipboard(decryptedText)}
            >Copiar Texto Descifrado</button
          >
        </div>
      {/if}
    </div>
