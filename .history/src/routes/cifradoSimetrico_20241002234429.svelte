    ...
    <form id="paymentForm">
      ...
      <div class="form-group" style="margin-top: 20px;">
        ...
        <input
          ...
          maxlength="8" <!-- Cambié el maxlength a 8 para que coincida con el tamaño del texto cifrado -->
          bind:value={decryptedCard} <!-- Esto se usará para mostrar el mensaje desencriptado -->
          required
        />
